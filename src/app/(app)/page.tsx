...
function categoryStyle(cat: string): { background: string; color: string; border: string } {
  if (cat.includes("high") || cat.includes("quality")) return { background: "#f0fdf4", color: "#15803d", border: "1px solid #bbf7d0" };
  if (cat.includes("suspicious") || cat.includes("spam")) return { background: "#fef2f2", color: "#b91c1c", border: "1px solid #fecaca" };
  if (cat.includes("trivial") || cat.includes("minor")) return { background: "#fffbeb", color: "#b45309", border: "1px solid #fde68a" };
  return { background: "transparent", color: "#71717a", border: "1px solid #e4e4e7" };
}
  ...
  return (
    <>
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "28px 40px 48px" }}>
        ...
        {/* Stat cards */}
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(160px, 1fr))", gap: "12px", marginBottom: "32px", maxWidth: "800px" }}>
          {statCards.map((s) => (
            ...
            <div style={{
              ...
              <a
                ...
                style={{
                  ...
                  padding: "6px 14px", background: "#fff", color: "#3f3f46",
