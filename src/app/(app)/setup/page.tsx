                ...
                <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                  ...
                  <div>
                    <div style={{ fontSize: "13px", fontWeight: 500, color: "#000" }}>
                      {ghUser ? `@${ghUser.login}` : "GitHub connected"}
                    </div>
                  ...
                  <div style={{ marginLeft: "auto", display: "flex", gap: "8px" }}>
                    ...
                    <button
                      ...
                      style={{ padding: "5px 12px", border: "1px solid #fecaca", borderRadius: "6px", background: "#fff", fontSize: "12px", color: "#ef4444", cursor: "pointer", fontFamily: "inherit" }}
                    >
                      Disconnect
                    </button>
                  </div>
                      ...
                      <div key={repo.fullName} style={{
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          <div style={{ display: "flex", alignItems: "center", gap: "6px", marginBottom: "2px" }}>
                            ...
                            <span style={{ fontSize: "13px", fontWeight: 500, color: "#000", fontFamily: "Geist Mono, monospace", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                              {repo.fullName}
                            </span>
                          </div>
                          {repo.description && (
